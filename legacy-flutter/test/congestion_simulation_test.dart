...
void main() {
  ...
  test(
    'Relay Queue: Should accept High Priority packets even when full of Low Priority',
    () async {
      ...
      // Verify full
      expect(
        await database.getRelayStorageSize(),
        AppConstants.relayQueueMaxCount,
      );
      ...
      expect(
        highPacket,
        isNotNull,
        reason: 'High priority packet should be accepted',
      );
      ...
      expect(
        low0,
        isNull,
        reason: 'Oldest low priority packet should be evicted',
      );
      ...
      expect(
        low1,
        isNotNull,
        reason: 'Newer low priority packet should remain',
      );
    },
  );

  test(
    'Relay Queue: Should REJECT Low Priority packet when full of High Priority',
    () async {
      ...
      expect(
        ...
        isNull,
        reason:
            'Low priority packet should be rejected when queue is full of high priority',
      );
