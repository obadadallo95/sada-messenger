...
final class $$ContactsTableTableReferences
    extends
        BaseReferences<_$TestDatabase, $ContactsTableTable, ContactsTableData> {
  ...
  _chatsTableRefsTable(_$TestDatabase db) => MultiTypedResultKey.fromTable(
    db.chatsTable,
...
class $$ContactsTableTableFilterComposer
    extends Composer<_$TestDatabase, $ContactsTableTable> {
...
class $$ContactsTableTableTableManager
    extends
        ...
        > {
  $$ContactsTableTableTableManager(_$TestDatabase db, $ContactsTableTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
final class $$ChatsTableTableReferences
    extends BaseReferences<_$TestDatabase, $ChatsTableTable, ChatsTableData> {
  $$ChatsTableTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $ContactsTableTable _peerIdTable(_$TestDatabase db) =>
  ...
  _messagesTableRefsTable(_$TestDatabase db) => MultiTypedResultKey.fromTable(
    db.messagesTable,
...
class $$ChatsTableTableFilterComposer
    extends Composer<_$TestDatabase, $ChatsTableTable> {
  $$ChatsTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$ChatsTableTableTableManager
    extends
        ...
        > {
  $$ChatsTableTableTableManager(_$TestDatabase db, $ChatsTableTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
final class $$MessagesTableTableReferences
    extends
        BaseReferences<_$TestDatabase, $MessagesTableTable, MessagesTableData> {
  ...
  static $ChatsTableTable _chatIdTable(_$TestDatabase db) =>
...
class $$MessagesTableTableFilterComposer
    extends Composer<_$TestDatabase, $MessagesTableTable> {
  $$MessagesTableTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$MessagesTableTableTableManager
    extends
        ...
        > {
  $$MessagesTableTableTableManager(_$TestDatabase db, $MessagesTableTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
