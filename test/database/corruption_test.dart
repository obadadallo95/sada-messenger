...
void main() {
  group('Database Corruption Tests', () {
    ...
    setUp(() async {
      ...
      await corruptFile.writeAsString('THIS IS NOT A SQLITE FILE. GARBAGE DATA HERE.');
    });
    ...
    test('Should throw generic DatabaseException when opening corrupted file', () async {
    ...
    test('Should recover by deleting file and recreating (Manual Recovery Logic)', () async {
      ...
      final executor2 = NativeDatabase(corruptFile); // Same path, but file is gone
