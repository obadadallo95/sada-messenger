...
> 
> **لا تعتمد على هذا التطبيق للاتصالات الحرجة للحياة بعد.**

---

## 📖 حول المشروع

**صدى (Sada)** هو تطبيق رسائل Mesh آمن ومفتوح المصدر مصمم خصيصاً للمجتمعات في سوريا والمناطق الأخرى التي تعاني من عدم استقرار الاتصال بالإنترنت. مبني على مبادئ إنسانية، يسمح صدى بالتواصل من نظير إلى نظير دون الحاجة إلى خوادم مركزية أو بنية تحتية للإنترنت.

### 🌍 المهمة

في المناطق التي يكون فيها الوصول إلى الإنترنت مقيداً أو غير موثوق أو خاضعاً للرقابة، يوفر صدى شبكة اتصال مرنة تعمل بالكامل بدون إنترنت باستخدام WiFi Direct و Bluetooth Low Energy (BLE). الرسائل مشفرة من طرف إلى طرف، مما يضمن الخصوصية حتى في البيئات المعادية.
...
- **تشفير من طرف إلى طرف**: تبادل مفاتيح X25519 + تشفير XSalsa20-Poly1305
- **السرية المستقبلية**: مفاتيح الجلسة المشتقة باستخدام ECDH و Blake2b
- **تخزين آمن**: المفاتيح الخاصة محفوظة في SharedPreferences المشفر (Android Keystore)

### 🛡️ **وضع الإكراه (نظام الذعر)**
- **نظام PIN مزدوج**: Master PIN (بيانات حقيقية) و Duress PIN (بيانات وهمية)
- **حماية خفية**: واجهة متطابقة في كلا الوضعين - لا توجد مؤشرات مرئية
- **الأمان الجسدي**: مصمم لحالات فحص الجهاز القسري
...
### 🎨 **واجهة مستخدم حديثة**
- **Material Design 3**: واجهة نظيفة وحديثة مع دعم الوضع الداكن/الفاتح
- **دعم RTL**: توطين كامل للعربية والإنجليزية
- **تصميم متجاوب**: تخطيطات متجاوبة قائمة على ScreenUtil
- **جولات تفاعلية**: أدلة اكتشاف الميزات للمستخدمين الجدد
...
- **Android Studio**: أحدث إصدار مع Android SDK 21+
